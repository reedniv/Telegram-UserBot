""" Userbot module for picked stickers or making new ones."""
...
EMOJI_STR = [
    ...
    "Roses are red violets are blue, picked this sticker so my pacc looks cool",
...
async def pick(args):
    """ For .pick command, picks stickers or creates new ones. """
    ...
    if message and message.media:
        if isinstance(message.media, MessageMediaPhoto):
            await args.edit(f"`{random.choice(EMOJI_STR)}`")
            photo = io.BytesIO()
        ...
        await args.edit("`I can't sticker that...`")
        return
...
\n\n.pick [number]\
\nUsage: pick's the sticker/image to the specified pack but uses ðŸ¤” as emoji.\
\n\n.pick [emoji('s)] [number]\
